...
// ModuleDashboardConfigModal - the gear-gated config for the Modules "Module-Dashboard"
// tile. Per the "all settings behind a gear" convention (StudioConfigModal canon).
...
export default function ModuleDashboardConfigModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <Overlay onClick={onClose}>
      <Panel onClick={(e) => e.stopPropagation()}>
        <Title>Module-Dashboard - Studio settings</Title>
        <Field>
