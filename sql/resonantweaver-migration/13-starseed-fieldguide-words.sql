  ...
  "prose": {
    ...
    "stars": {
      ...
      "ursa_minor": {
       ...
       updated_at = now()
 WHERE p.site = 'resonantweaver' AND p.slug = 'galactic-field-guide' AND p.lang = 'en'
...
BEGIN
  ...
  IF n <> 1 THEN
    RAISE EXCEPTION 'assert: expected one rf-field-guide section carrying 42 dossiers and 62 star cards, found %', n;
  END IF;
